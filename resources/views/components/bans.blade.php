<div class="overflow-x-auto whitespace-nowrap md:whitespace-normal">
  <table class="table-auto display w-full text-sm text-left text-gray-500 dark:text-gray-400" id="table_bans">
